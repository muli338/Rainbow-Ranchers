...
if(isset($_POST['save']))
{
  ...
  $sql="insert into tblbreed(CategoryName,ProductName,ProductPrice,ProductAmount,ProductCalving,ProductImage)values(:category,:product,:price,:amount,:calving,:image)";
  ...
  if ($LastInsertId>0) 
  {
    ...
    echo "<script>window.location.href ='breed.php'</script>";
  }
  else
  {
...
if(isset($_GET['del'])){    
  $cmpid=$_GET['del'];
  $query=mysqli_query($con,"delete from tblbreed where id='$cmpid'");
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
               <div class="modal-header">
                <h5 class="modal-title" style="float: left;">Register Cow A.I Serve</h5>
              </div>
              <div class="col-md-12 mt-4">
                <form class="forms-sample" method="post" enctype="multipart/form-data" class="form-horizontal">
                  <div class="row ">
                    ...
                    <div class="form-group col-md-6">
                      <label for="exampleInputName1">Artificial Infamation</label>
                      <input type="text" name="product" class="form-control" value="" id="product" placeholder="Enter A.I serve" required>
                    </div>
                    <div class="form-group col-md-6">
                      <label for="exampleInputName1">Drying </label>
                      <input type="text" name="amount" class="form-control" value="" id="amount" placeholder="Enter Drying Period" required>
                    </div>
                    <div class="form-group col-md-6">
                      <label for="exampleInputName1">Pregnancy Diagonosis </label>
                      <input type="text" name="price" class="form-control" value="" id="amount" placeholder="Enter Pregnancy Diagnosis" required>
                    </div>
                  </div>
                  <div class="row ">
                    <div class="form-group col-md-6">
                      <label for="exampleInputName1">Calving</label>
                      <input type="text" name="calving" value="" placeholder="Enter Calving Period" class="form-control" id="price"required>
                    </div>
                    <div class="form-group col-md-6 pl-md-0">
                      <label class="col-sm-12 pl-0 pr-0 ">Attach A.I Photo</label>
                ...
                <table class="table align-items-center table-flush table-hover table-bordered" id="dataTableHover">
                  <thead>
                    <tr>
                      ...
                      <th>A.I Infamation</th>
                      <th class="text-center"> Cow Name</th>
                      <th class="text-center"> Drying</th>
                      <th class="text-center"> Pregnancy Diagnosis</th>
                  ...
                  <tbody>
                    <?php
                    $sql="SELECT tblbreed.id,tblbreed.CategoryName,tblbreed.ProductName,tblbreed.PostingDate,tblbreed.ProductPrice,tblbreed.ProductAmount,tblbreed.ProductCalving,tblbreed.ProductImage from tblbreed ORDER BY id DESC";
                    $query = $dbh -> prepare($sql);
                    $query->execute();
                    $results=$query->fetchAll(PDO::FETCH_OBJ);
                    $cnt=1;
                      ...
                      { 
                        ...
                        <tr>
                          ...
                          <td class=" text-center"><a href="#"  class=" edit_data4" id="<?php echo  ($row->id); ?>" title="click to edit"><i class="mdi mdi-pencil-box-outline" aria-hidden="true"></i></a>
                            ...
                            <a href="breed.php?del=<?php echo ($row->id);?>" data-toggle="tooltip" data-original-title="Delete" onclick="return confirm('Do you really want to delete?');"> <i class="mdi mdi-delete"></i> </a>
                          </td>
                        </tr>
                        <?php 
                        $cnt=$cnt+1;
