...
if(isset($_POST['insert']))
{
    ...
    $sql4="update tblmales set CategoryName=:category,ProductName=:product,ProductPrice=:price,ProductAmount=:amount,ProductSales=:sales,ProductCalving=:calving where id=:eib";
...
<div class="card-body">
    <?php
    $eid=$_POST['edit_id4'];
    $sql2="SELECT tblmales.id,tblmales.CategoryName,tblmales.ProductName,tblmales.PostingDate,tblmales.ProductPrice,tblmales.ProductAmount,tblmales.ProductSales,tblmales.ProductCalving,tblmales.ProductImage from tblmales where tblmales.id=:eid";
