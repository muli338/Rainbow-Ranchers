 <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
  ...
  <div class="navbar-menu-wrapper d-flex align-items-stretch">
    <button class="navbar-toggler navbar-toggler align-self-center text-black" type="button" data-toggle="maximize">
    ...
    <div class="search-field d-none d-md-block">
      <form class="d-flex align-items-center h-100" action="#">
        <div class="input-group">
          ...
          <input type="text" class="form-control bg-transparent border-0 text-capitalize" placeholder="Welcome Farm Manager">
        </div>
      </form>
    </div>
