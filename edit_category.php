...
if(isset($_POST['insert']))
{
    ...
    $image=$_POST['image'];
    $serve=$_POST['serve'];
    $sql4="update tblcategory set CategoryName=:category,CategorySex=:sex,CategoryCalving=:calving,CategoryServe=:serve,CategoryDate=:date,ProductImage=:image,CategoryDry=:dry,CategoryCode=:code where id=:eib";
...
<div class="card-body">
    <?php
    $eid=$_POST['edit_id4'];
    $sql2="SELECT tblcategory.id,tblcategory.CategoryName,tblcategory.CategoryCode,tblcategory.CategorySex,tblcategory.CategoryDry,tblcategory.CategoryCalving,tblcategory.CategoryDate,tblcategory.CategorySex,tblcategory.CategoryServe,tblcategory.ProductImage,tblcategory.PostingDate from tblcategory  where tblcategory.id=:eid";
