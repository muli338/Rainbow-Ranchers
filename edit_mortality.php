...
if(isset($_POST['insert']))
{
    ...
    $price=$_POST['price'];
    $amount=$_POST['amount'];
    $sql4="update tblmortality set CategoryName=:category,ProductName=:product,ProductPrice=:price,ProductAmount=:amount where id=:eib";
...
<div class="card-body">
    <?php
    $eid=$_POST['edit_id4'];
    $sql2="SELECT tblmortality.id,tblmortality.CategoryName,tblmortality.ProductName,tblmortality.PostingDate,tblmortality.ProductPrice,tblmortality.ProductAmount,tblmortality.ProductImage from tblmortality where tblmortality.id=:eid";
        ...
        foreach($results as $row)
        {
            ...
            <form class="form-sample"  method="post" enctype="multipart/form-data">
                <div class="control-group">
                    <label class="control-label" for="basicinput">Dead Cow Image</label>
                    <div class="controls">
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        <label class="col-sm-12 pl-0 pr-0">Death Reason</label>
                        <div class="col-sm-12 pl-0 pr-0">
                ...
                <div class="row">
                    <div class="form-group col-md-12 ">
                        <label class="col-sm-12 pl-0 pr-0">Was it Treated?</label>
                        <div class="col-sm-12 pl-0 pr-0">
                ...
                <div class="row">
                    <div class="form-group col-md-12 ">
                        <label class="col-sm-12 pl-0 pr-0">Treated By</label>
                        <div class="col-sm-12 pl-0 pr-0">
