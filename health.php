...
if(isset($_POST['save']))
{
  ...
  $sql="insert into tblhealth(CategoryName,ProductName,ProductPrice,ProductAmount,ProductImage)values(:category,:product,:price,:amount,:image)";
  ...
  if ($LastInsertId>0) 
  {
    ...
    echo "<script>window.location.href ='health.php'</script>";
  }
  else
  {
...
if(isset($_GET['del'])){    
  $cmpid=$_GET['del'];
  $query=mysqli_query($con,"delete from tblhealth where id='$cmpid'");
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
               <div class="modal-header">
                <h5 class="modal-title" style="float: left;">Register Cow Health Status</h5>
              </div>
                ...
                <form class="forms-sample" method="post" enctype="multipart/form-data" class="form-horizontal">
                  <div class="row ">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" name="product" class="form-control" value="" id="product" placeholder="Enter Cow Disease" required>
                    </div>
                    <div class="form-group col-md-6">
                      <label for="exampleInputName1">Disease treatment i.e vaccination </label>
                      <input type="text" name="amount" class="form-control" value="" id="amount" placeholder="Enter Cow Treatment Method" required>
                    </div>
                  </div>
                  <div class="row ">
                    <div class="form-group col-md-6">
                      <label for="exampleInputName1">Cost</label>
                      <input type="text" name="price" value="" placeholder="Enter Cost for Treatment" class="form-control" id="price"required>
                    </div>
            ...
            <div class="card">
              ...
              <div id="editData4" class="modal fade">
                <div class="modal-dialog modal-md">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title">Edit Health details</h5>
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                      </button>
                    </div>
                    <div class="modal-body" id="info_update4">
                      <?php @include("edit_health.php");?>
                    </div>
              ...
              <div id="editData5" class="modal fade">
                <div class="modal-dialog modal-md">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title">View Health details</h5>
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                      </button>
                    </div>
                    <div class="modal-body" id="info_update5">
                      <?php @include("view_health.php");?>
                    </div>
                    <div class="modal-footer ">
                      <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                    </div>
                ...
                <table class="table align-items-center table-flush table-hover table-bordered" id="dataTableHover">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center">Diease Treatment</th>
                  ...
                  <tbody>
                    <?php
                    $sql="SELECT tblhealth.id,tblhealth.CategoryName,tblhealth.ProductName,tblhealth.PostingDate,tblhealth.ProductPrice,tblhealth.ProductAmount,tblhealth.ProductImage from tblhealth ORDER BY id DESC";
                    $query = $dbh -> prepare($sql);
                    $query->execute();
                    $results=$query->fetchAll(PDO::FETCH_OBJ);
                    $cnt=1;
                      ...
                      { 
                        ...
                        <tr>
                          ...
                          <td class=" text-center"><a href="#"  class=" edit_data4" id="<?php echo  ($row->id); ?>" title="click to edit"><i class="mdi mdi-pencil-box-outline" aria-hidden="true"></i></a>
                            ...
                            <a href="health.php?del=<?php echo ($row->id);?>" data-toggle="tooltip" data-original-title="Delete" onclick="return confirm('Do you really want to delete?');"> <i class="mdi mdi-delete"></i> </a>
                          </td>
                        </tr>
                        <?php 
                        $cnt=$cnt+1;
