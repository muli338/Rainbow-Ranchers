...
<div class="card-body">
  <?php
  $eid=$_POST['edit_id5'];
  $sql="SELECT tblbull.id,tblbull.CategoryName,tblbull.ProductName,tblbull.PostingDate,tblbull.ProductPrice,tblbull.ProductAmount,tblbull.ProductSales,tblbull.ProductCalving,tblbull.ProductImage from tblbull  where tblbull.id=:eid";
  ...
  if($query->rowCount() > 0)
  {
    foreach($results as $row)
      {?>
        ...
        <h4 style="color: blue">View Bull Category Information</h4>
