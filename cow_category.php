...
if(isset($_POST['save']))
{
  ...
  $sql="insert into tblcow(CategoryName,ProductName,ProductPrice,ProductAmount,ProductSales,ProductCalving,ProductImage)values(:category,:product,:price,:amount,:sales,:calving,:image)";
  ...
  if ($LastInsertId>0) 
  {
    ...
    echo "<script>window.location.href ='cow_category.php'</script>";
  }
  else
  {
...
if(isset($_GET['del'])){    
  $cmpid=$_GET['del'];
  $query=mysqli_query($con,"delete from tblcow where id='$cmpid'");
            ...
            <div class="card">
                ...
                <div class="modal-dialog modal-md">
                  <div class="modal-content">
                    ...
                    <div class="modal-body" id="info_update4">
                      <?php @include("edit_cow_category.php");?>
                    </div>
                ...
                <div class="modal-dialog modal-md">
                  <div class="modal-content">
                    ...
                    <div class="modal-body" id="info_update5">
                      <?php @include("view_cow_category.php");?>
                    </div>
                    <div class="modal-footer ">
                      <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                    </div>
              ...
              <div class="table-responsive p-3">
                <table class="table align-items-center table-flush table-hover table-bordered" id="dataTableHover">
                  ...
                  <tbody>
                    <?php
                    $sql="SELECT tblcow.id,tblcow.CategoryName,tblcow.ProductName,tblcow.PostingDate,tblcow.ProductPrice,tblcow.ProductAmount,tblcow.ProductSales,tblcow.ProductCalving,tblcow.ProductImage from tblcow ORDER BY id DESC";
                    $query = $dbh -> prepare($sql);
                    $query->execute();
                    $results=$query->fetchAll(PDO::FETCH_OBJ);
                    $cnt=1;
                      ...
                      { 
                        ...
                        <tr>
                          ...
                          <td class=" text-center"><a href="#"  class=" edit_data4" id="<?php echo  ($row->id); ?>" title="click to edit"><i class="mdi mdi-pencil-box-outline" aria-hidden="true"></i></a>
                            ...
                            <a href="cow_category.php?del=<?php echo ($row->id);?>" data-toggle="tooltip" data-original-title="Delete" onclick="return confirm('Do you really want to delete?');"> <i class="mdi mdi-delete"></i> </a>
                          </td>
                        </tr>
                        <?php 
                        $cnt=$cnt+1;
