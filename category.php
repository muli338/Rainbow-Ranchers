...
if(isset($_POST['save']))
{
  ...
  $serve=$_POST['serve'];
  $sql="insert into tblcategory(CategoryName,CategoryCode,CategoryBreed,CategorySire,CategorySex,CategoryDry,CategoryCalving,CategoryDate,ProductImage,CategoryServe)values(:category,:code,:sire,:breed,:serve,:dry,:calving,:date,:image,:sex)";
            ...
            <div class="card">
              ...
              <div class="table-responsive p-3">
                <table class="table align-items-center table-flush table-hover table-bordered" id="dataTableHover">
                  ...
                  <tbody>
                    <?php
                    $sql="SELECT tblcategory.id,tblcategory.CategoryName,tblcategory.CategoryCode,tblcategory.CategorySire,tblcategory.CategoryBreed,tblcategory.CategorySex,tblcategory.CategoryDate,tblcategory.CategoryServe,tblcategory.CategoryDry,tblcategory.CategoryCalving,tblcategory.ProductImage,tblcategory.PostingDate from tblcategory ORDER BY id DESC";
                    $query = $dbh -> prepare($sql);
                    $query->execute();
