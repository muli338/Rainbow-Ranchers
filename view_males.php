...
<div class="card-body">
  <?php
  $eid=$_POST['edit_id5'];
  $sql="SELECT tblmales.id,tblmales.CategoryName,tblmales.ProductName,tblmales.PostingDate,tblmales.ProductPrice,tblmales.ProductAmount,tblmales.ProductSales,tblmales.ProductCalving,tblmales.ProductImage from tblmales  where tblmales.id=:eid";
  ...
  if($query->rowCount() > 0)
  {
    foreach($results as $row)
      {?>
        ...
        <h4 style="color: blue">View Males Category Information</h4>
