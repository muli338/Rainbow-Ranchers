          ...
          <div class="row">
            <div class="col-md-4 stretch-card grid-margin">
              <div class="card bg-gradient-info card-img-holder text-white" style="height: 150px;">
                <div class="card-body" >
                  ...
                  <h4 class="font-weight-normal mb-3">Registered Managers
                  </h4>
                  <?php 
            ...
            <div class="col-md-4 stretch-card grid-margin">
              <div class="card bg-gradient-info card-img-holder text-white" style="height: 150px;">
                <div class="card-body">
                  ...
                  <?php
                  $sql=mysqli_query($con,"select id from tblemployee");
            ...
            <div class="col-md-4 stretch-card grid-margin">
              <div class="card bg-gradient-info card-img-holder text-white" style="height: 150px;">
                <div class="card-body">
                  <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                  <h4 class="font-weight-normal mb-3">Total Cows 
                  </h4>
                  <?php
            ...
            <div class="col-md-4 stretch-card grid-margin">
              <div class="card bg-gradient-info card-img-holder text-white" style="height: 150px;">
                <div class="card-body">
                  <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                  <h4 class="font-weight-normal mb-3">Total Heifers/Incalves 
                  </h4>
                  <?php
                  $sql=mysqli_query($con,"select id from tblheifers");
                  $listedproduct=mysqli_num_rows($sql);
                  ?>
                  <h2 class="mb-5"><?php echo $listedproduct;?></h2>
                </div>
            ...
            <div class="col-md-4 stretch-card grid-margin">
              <div class="card bg-gradient-info card-img-holder text-white" style="height: 150px;">
                <div class="card-body">
                  ...
                  <?php
                  $query=mysqli_query($con,"select sum(tblexpense.ProductAmount) as total  from tblexpense");
                  $row=mysqli_fetch_array($query);
                  ?>
                  <h2 class="mb-5"><?php echo number_format($row['total'],2);?></h2>
                </div>
