...
if(isset($_POST['insert']))
{
    ...
    $sql4="update tblcalves set CategoryName=:category,ProductName=:product,ProductPrice=:price,ProductAmount=:amount,ProductSales=:sales,ProductCalving=:calving where id=:eib";
...
<div class="card-body">
    <?php
    $eid=$_POST['edit_id4'];
    $sql2="SELECT tblcalves.id,tblcalves.CategoryName,tblcalves.ProductName,tblcalves.PostingDate,tblcalves.ProductPrice,tblcalves.ProductAmount,tblcalves.ProductSales,tblcalves.ProductCalving,tblcalves.ProductImage from tblcalves where tblcalves.id=:eid";
