...
if(isset($_POST['save']))
{
  ...
  $sql="insert into tblemployee(CategoryName,ProductName,ProductPrice,ProductImage)values(:category,:product,:price,:image)";
...
if(isset($_GET['del'])){    
  $cmpid=$_GET['del'];
  $query=mysqli_query($con,"delete from tblemployee where id='$cmpid'");
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
               <div class="modal-header">
                <h5 class="modal-title" style="float: left;">Register New Employees</h5>
              </div>
              <div class="col-md-12 mt-4">
                <form class="forms-sample" method="post" enctype="multipart/form-data" class="form-horizontal">
                  <div class="row ">
                  <div class="form-group col-md-6">
                      <label for="exampleInputName1">Employee Full Names </label>
                      <input type="text" name="category" class="form-control" value="" id="category" placeholder="Enter Employee full names" required>
                    </div>
                    <div class="form-group col-md-6">
                      <label for="exampleInputName1">Employee Role i.e Expert,Manager,Casual </label>
                      <input type="text" name="product" class="form-control" value="" id="product" placeholder="Enter Product" required>
                    </div>
                  </div>
                  <div class="row ">
                    <div class="form-group col-md-6">
                      <label for="exampleInputName1">Employee Salary</label>
                    ...
                    <div class="form-group col-md-6 pl-md-0">
                      <label class="col-sm-12 pl-0 pr-0 ">Attach Employee Photo</label>
                ...
                <table class="table align-items-center table-flush table-hover table-bordered" id="dataTableHover">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center">Employed Date</th>
                      <th class=" Text-center" style="width: 15%;">Action</th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php
                    $sql="SELECT tblemployee.id,tblemployee.CategoryName,tblemployee.ProductName,tblemployee.PostingDate,tblemployee.ProductPrice,tblemployee.ProductImage from tblemployee ORDER BY id DESC";
                    $query = $dbh -> prepare($sql);
                    $query->execute();
                    ...
                    if($query->rowCount() > 0)
                    {
                      ...
                      { 
                        ...
                        <tr>
                          ...
                          <td>
                            <img src="productimages/<?php  echo $row->ProductImage;?>" class="mr-2" alt="image"><a href="#"class=" edit_data5" id="<?php echo  ($row->id); ?>" ><?php  echo htmlentities($row->CategoryName);?></a>
                          </td>
                          ...
                          <td class=" text-center"><a href="#"  class=" edit_data4" id="<?php echo  ($row->id); ?>" title="click to edit"><i class="mdi mdi-pencil-box-outline" aria-hidden="true"></i></a>
                            ...
                            <a href="employee.php?del=<?php echo ($row->id);?>" data-toggle="tooltip" data-original-title="Delete" onclick="return confirm('Do you really want to delete?');"> <i class="mdi mdi-delete"></i> </a>
                          </td>
                        </tr>
                        <?php 
                        $cnt=$cnt+1;
