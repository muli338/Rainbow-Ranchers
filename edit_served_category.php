...
if(isset($_POST['insert']))
{
    ...
    $sql4="update tblserved set CategoryName=:category,ProductName=:product,ProductPrice=:price,ProductAmount=:amount,ProductSales=:sales,ProductCalving=:calving where id=:eib";
...
<div class="card-body">
    <?php
    $eid=$_POST['edit_id4'];
    $sql2="SELECT tblserved.id,tblserved.CategoryName,tblserved.ProductName,tblserved.PostingDate,tblserved.ProductPrice,tblserved.ProductAmount,tblserved.ProductSales,tblserved.ProductCalving,tblserved.ProductImage from tblserved where tblserved.id=:eid";
