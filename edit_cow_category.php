...
if(isset($_POST['insert']))
{
    ...
    $sql4="update tblcow set CategoryName=:category,ProductName=:product,ProductPrice=:price,ProductAmount=:amount,ProductSales=:sales,ProductCalving=:calving where id=:eib";
...
<div class="card-body">
    <?php
    $eid=$_POST['edit_id4'];
    $sql2="SELECT tblcow.id,tblcow.CategoryName,tblcow.ProductName,tblcow.PostingDate,tblcow.ProductPrice,tblcow.ProductAmount,tblcow.ProductSales,tblcow.ProductCalving,tblcow.ProductImage from tblcow where tblcow.id=:eid";
