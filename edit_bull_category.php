...
if(isset($_POST['insert']))
{
    ...
    $sql4="update tblbull set CategoryName=:category,ProductName=:product,ProductPrice=:price,ProductAmount=:amount,ProductSales=:sales,ProductCalving=:calving where id=:eib";
...
<div class="card-body">
    <?php
    $eid=$_POST['edit_id4'];
    $sql2="SELECT tblbull.id,tblbull.CategoryName,tblbull.ProductName,tblbull.PostingDate,tblbull.ProductPrice,tblbull.ProductAmount,tblbull.ProductSales,tblbull.ProductCalving,tblbull.ProductImage from tblbull where tblbull.id=:eid";
