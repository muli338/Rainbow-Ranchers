...
<div class="card-body">
  ...
  <?php
  $eid=$_POST['edit_id5'];
  $sql="SELECT tblheifers.id,tblheifers.CategoryName,tblheifers.CategoryCode,tblheifers.CategoryBreed,tblheifers.CategorySire,tblheifers.CategoryServe,tblheifers.CategorySex,tblheifers.CategoryDry,tblheifers.CategoryCalving,tblheifers.CategoryDate,tblheifers.ProductImage,tblheifers.PostingDate from tblheifers  where tblheifers.id=:eid";
