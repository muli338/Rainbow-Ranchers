...
if(isset($_POST['insert']))
{
    ...
    $price=$_POST['price'];
    $amount=$_POST['amount'];
    $sql4="update tblhealth set CategoryName=:category,ProductName=:product,ProductPrice=:price,ProductAmount=:amount where id=:eib";
...
<div class="card-body"> 
    <?php
    $eid=$_POST['edit_id4'];
    $sql2="SELECT tblhealth.id,tblhealth.CategoryName,tblhealth.ProductName,tblhealth.PostingDate,tblhealth.ProductPrice,tblhealth.ProductAmount,tblhealth.ProductImage from tblhealth where tblhealth.id=:eid";
        ...
        foreach($results as $row)
        {
            ...
            <form class="form-sample"  method="post" enctype="multipart/form-data">
                <div class="control-group">
                    <label class="control-label" for="basicinput">Disease Image</label>
                    <div class="controls">
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        <label class="col-sm-12 pl-0 pr-0"> Cow Disease</label>
                        <div class="col-sm-12 pl-0 pr-0">
                ...
                <div class="row">
                    <div class="form-group col-md-12 ">
                        <label class="col-sm-12 pl-0 pr-0">Treatment Cost</label>
                        <div class="col-sm-12 pl-0 pr-0">
                ...
                <div class="row">
                    <div class="form-group col-md-12 ">
                        <label class="col-sm-12 pl-0 pr-0">Disease Treatment</label>
                        <div class="col-sm-12 pl-0 pr-0">
