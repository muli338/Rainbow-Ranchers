...
if(isset($_POST['save']))
{
  ...
  $sql="insert into tblproducts(CategoryName,ProductName,ProductPrice,ProductAmount,ProductImage)values(:category,:product,:price,:amount,:image)";
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
               <div class="modal-header">
                <h5 class="modal-title" style="float: left;">Register Cow Product</h5>
              </div>
              <div class="col-md-12 mt-4">
                <form class="forms-sample" method="post" enctype="multipart/form-data" class="form-horizontal">
                  <div class="row ">
                    ...
                    <div class="form-group col-md-6">
                      <label for="exampleInputName1">Product Amount in Litres </label>
                      <input type="text" name="amount" class="form-control" value="" id="amount" placeholder="Enter Product Amount in Litres" required>
                    </div>
                  </div>
                  <div class="row ">
                    <div class="form-group col-md-6">
                ...
                <table class="table align-items-center table-flush table-hover table-bordered" id="dataTableHover">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center"> Product Amount in Litres</th>
                  ...
                  <tbody>
                    <?php
                    $sql="SELECT tblproducts.id,tblproducts.CategoryName,tblproducts.ProductName,tblproducts.PostingDate,tblproducts.ProductPrice,tblproducts.ProductAmount,tblproducts.ProductImage from tblproducts ORDER BY id DESC";
                    $query = $dbh -> prepare($sql);
                    $query->execute();
                    $results=$query->fetchAll(PDO::FETCH_OBJ);
                    $cnt=1;
                    if($query->rowCount() > 0)
                    {
                      ...
                      { 
                        ...
                        <tr>
                          ...
                          <td class="text-center"><?php  echo htmlentities($row->ProductAmount);?> Litres</td>
