...
if(isset($_POST['insert']))
{
    ...
    $sql4="update tblmaiden set CategoryName=:category,ProductName=:product,ProductPrice=:price,ProductAmount=:amount,ProductSales=:sales,ProductCalving=:calving where id=:eib";
...
<div class="card-body">
    <?php
    $eid=$_POST['edit_id4'];
    $sql2="SELECT tblmaiden.id,tblmaiden.CategoryName,tblmaiden.ProductName,tblmaiden.PostingDate,tblmaiden.ProductPrice,tblmaiden.ProductAmount,tblmaiden.ProductSales,tblmaiden.ProductCalving,tblmaiden.ProductImage from tblmaiden where tblmaiden.id=:eid";
