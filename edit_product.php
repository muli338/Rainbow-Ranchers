...
if(isset($_POST['insert']))
{
    ...
    $price=$_POST['price'];
    $amount=$_POST['amount'];
    $sql4="update tblproducts set CategoryName=:category,ProductName=:product,ProductPrice=:price,ProductAmount=:amount where id=:eib";
...
<div class="card-body">
    <?php
    $eid=$_POST['edit_id4'];
    $sql2="SELECT tblproducts.id,tblproducts.CategoryName,tblproducts.ProductName,tblproducts.PostingDate,tblproducts.ProductPrice,tblproducts.ProductAmount,tblproducts.ProductImage from tblproducts where tblproducts.id=:eid";
    ...
    if($query2->rowCount() > 0)
    {
        foreach($results as $row)
        {
            ...
            <form class="form-sample"  method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="form-group col-md-12 ">
                        <label class="col-sm-12 pl-0 pr-0">Product Amount</label>
                        <div class="col-sm-12 pl-0 pr-0">
                            <input type="number" name="amount" value="<?php  echo $row->ProductAmount;?>" class="form-control" required>
                        </div>
                    </div>
                </div>
