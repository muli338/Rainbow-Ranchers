...
<div class="card-body">
  <?php
  $eid=$_POST['edit_id5'];
  $sql="SELECT tblcow.id,tblcow.CategoryName,tblcow.ProductName,tblcow.PostingDate,tblcow.ProductPrice,tblcow.ProductAmount,tblcow.ProductSales,tblcow.ProductCalving,tblcow.ProductImage from tblcow  where tblcow.id=:eid";
