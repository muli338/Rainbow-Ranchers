...
<div class="card-body">
  <?php
  $eid=$_POST['edit_id5'];
  $sql="SELECT tblstar.id,tblstar.CategoryName,tblstar.ProductName,tblstar.PostingDate,tblstar.ProductPrice,tblstar.ProductAmount,tblstar.ProductSales,tblstar.ProductCalving,tblstar.ProductImage from tblstar  where tblstar.id=:eid";
  ...
  if($query->rowCount() > 0)
  {
    foreach($results as $row)
      {?>
        ...
        <h4 style="color: blue">View Cow Star Category Information</h4>
