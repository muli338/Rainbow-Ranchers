...
if(isset($_POST['insert']))
{
    ...
    $sql4="update tblbreed set CategoryName=:category,ProductName=:product,ProductPrice=:price,ProductAmount=:amount,ProductCalving=:calving where id=:eib";
...
<div class="card-body">
    <?php
    $eid=$_POST['edit_id4'];
    $sql2="SELECT tblbreed.id,tblbreed.CategoryName,tblbreed.ProductName,tblbreed.PostingDate,tblbreed.ProductPrice,tblbreed.ProductAmount,tblbreed.ProductCalving,tblbreed.ProductImage from tblbreed where tblbreed.id=:eid";
    ...
    if($query2->rowCount() > 0)
    {
        foreach($results as $row)
        {
            ...
            <form class="form-sample"  method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        <label class="col-sm-12 pl-0 pr-0">A.i Infammation</label>
                        <div class="col-sm-12 pl-0 pr-0">
                ...
                <div class="row">
                    <div class="form-group col-md-12 ">
                        <label class="col-sm-12 pl-0 pr-0">Pregnancy Diagnosis</label>
                        <div class="col-sm-12 pl-0 pr-0">
                ...
                <div class="row">
                    <div class="form-group col-md-12 ">
                        <label class="col-sm-12 pl-0 pr-0">Drying</label>
                        <div class="col-sm-12 pl-0 pr-0">
                ...
                <div class="row">
                    <div class="form-group col-md-12 ">
                        <label class="col-sm-12 pl-0 pr-0">Calving</label>
                        <div class="col-sm-12 pl-0 pr-0">
